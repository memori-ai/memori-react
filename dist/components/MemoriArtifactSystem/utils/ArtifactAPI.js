...
exports.ArtifactAPIBridge = exports.initMemoriArtifactAPI = void 0;
const react_1 = require("react");
const ArtifactContext_1 = require("../context/ArtifactContext");
const pendingCalls = [];
let isReady = false;
const initMemoriArtifactAPI = () => {
...
exports.initMemoriArtifactAPI = initMemoriArtifactAPI;
(0, exports.initMemoriArtifactAPI)();
const ArtifactAPIBridge = ({ pushMessage, }) => {
    const { openArtifact, closeArtifact, toggleFullscreen, state, registerArtifact } = (0, ArtifactContext_1.useArtifact)();
...
exports.ArtifactAPIBridge = ArtifactAPIBridge;
