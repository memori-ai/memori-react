...
exports.getErrori18nKey = exports.BACKEND_ERRORS = void 0;
const errors = {
    TENANT_NOT_FOUND: -1,
...
exports.BACKEND_ERRORS = new Map(Object.entries(errors).map(([key, value]) => [value, key]));
const getErrori18nKey = (errorCode) => {
    if (!errorCode)
    ...
    let error = exports.BACKEND_ERRORS.get(errorCode);
    if (!error) {
        return 'error.generic';
    }
    else {
...
exports.getErrori18nKey = getErrori18nKey;
