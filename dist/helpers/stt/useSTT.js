...
function useSTT(config, processSpeechAndSendMessage, options = {}, defaultEnableAudio = true) {
    const [recordingState, setRecordingState] = (0, react_1.useState)('idle');
    const [microphoneMuted, setMicrophoneMuted] = (0, react_1.useState)((0, configuration_1.getLocalConfig)('muteMicrophone', !defaultEnableAudio));
    const [hasUserActivatedRecord, setHasUserActivatedRecord] = (0, react_1.useState)(false);
    ...
    const transcribeAudio = (0, react_1.useCallback)(async (audioBlob) => {
        var _a;
    ...
    const toggleRecording = (0, react_1.useCallback)(async () => {
