...
export const generateChatPDFCSS = (options = {}) => {
...
const formatMessageBubble = (message, language = 'en') => {
    ...
    const { text: renderedText } = renderMsg(cleanText, false, 'Reasoning...', false);
...
export const formatChatHistoryForPDF = (params) => {
...
export const createChatPDFDocument = (htmlContent, title, options = {}) => {
