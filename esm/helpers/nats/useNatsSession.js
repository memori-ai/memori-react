...
import { wsconnect, jwtAuthenticator, AuthorizationError, UserAuthenticationExpiredError, } from '@nats-io/nats-core';
import { jetstream, DeliverPolicy, } from '@nats-io/jetstream';
export function isNatsAuthError(error) {
...
export function normalizeNatsEvent(raw) {
    var _a, _b, _c;
...
export function useNatsSession(sessionId, config, onMessage, lifecycle = {}) {
    const connRef = useRef(null);
    const consumerMessagesRef = useRef(null);
