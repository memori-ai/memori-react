...
export function useTTS(config, options = {}, autoStart = false, defaultEnableAudio = true, defaultSpeakerActive = true) {
    ...
    const currentChunkAudioRef = useRef(null);
    ...
    const createChunks = useCallback((text, maxLength = 800) => {
    ...
    const speakChunk = useCallback(async (chunkText) => {
