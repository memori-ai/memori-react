...
export const WithDocumentTags: Story = {
  args: {
    ...
    apiClient: {
      chatLogs: {
        getUserChatLogsByToken: () => Promise.resolve({ chatLogs: mockChatLogsWithTags }),
        getUserChatLogsByTokenPaged: () => Promise.resolve({ chatLogs: mockChatLogsWithTags, totalItems: 1 }),
      },
    } as any,
  },
};
