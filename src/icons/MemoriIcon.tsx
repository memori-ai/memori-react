...
const MemoriIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    className="memori-ai-logo"
    width={800}
    height={800}
    fill="currentColor"
    viewBox="0 0 670.70013 639.67999"
    aria-label="Memori AI"
    {...props}
  >
    <defs>
      <style>
      ...
      <linearGradient
        ...
        gradientTransform="translate(-304.65445,-80.16)"
      >
        <stop offset={0.18} stopColor="#9ad2d5" id="stop1" />
        <stop offset={0.32} stopColor="#26b5cb" id="stop2" />
        <stop offset={0.38} stopColor="#379cbe" id="stop3" />
        <stop offset={0.46} stopColor="#4c7eb0" id="stop4" />
        <stop offset={0.55} stopColor="#5d66a4" id="stop5" />
        <stop offset={0.65} stopColor="#69569c" id="stop6" />
        <stop offset={0.76} stopColor="#704c97" id="stop7" />
        <stop offset={0.89} stopColor="#734996" id="stop8" />
      </linearGradient>
    </defs>
    <g id="g13" transform="translate(-304.65445,-80.16)">
      <path
        className="cls-2"
